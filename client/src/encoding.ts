 ...
 */
export function decimalToBytes(decimal: string, size: number): Uint8Array {
...
export function signalToBytes(decimal: string): Uint8Array {
 ...
 */
export function proofToBytes(proof: SnarkJsGroth16Proof): ContractProofBytes {
